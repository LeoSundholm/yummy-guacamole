...
--local hintChars = {"A","S","D","F","Z","X","C","Q","W","E"}
local hintChars = {"A","O","E","U","Q","J","I","D","H"}
local usedChars = 0
...
function hints.windowHints()
  ...
  win[] windows = window.allwindows()


  for i,win in ipairs(window.allwindows()) do
    if win:application():title() == "Google Chrome" and win:title() ~= "" then
      hints.newWinChar(win,"")
    elseif win:application():title() == "Unity" and win:title() ~= "" then
      hints.newWinChar(win,"")
    elseif win:application():title() ~= "Google Chrome" and win:application():title() ~= "Unity" and win:application():title() ~= "TotalSpaces2" and win:application():title() ~= "Karabiner" then
      hints.newWinChar(win,"")
    end
  end
end
